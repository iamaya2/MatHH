...
%     fprintf('Testing equality of %s contents...', class(obj1))
%     %     if isequaln(thisObj,thatObj) == result
%     %         status = 1;
%     %         fprintf(' PASS!\n');
...
%                 status = checkForEquality(thisObj.(thisProp)(idy),thatObj.(thisProp)(idy),result, thisDepth+1);
%             end
%         else
%             if result
